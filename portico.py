...
rest_DoF = restricciones.flatten() #poner en un vector corrido
print(rest_DoF)
...
# Vector de fuerzas en los elmentos (puntuales o distribuidas)
...
for e, elem in enumerate(elementos): 
    ...
    Foz = [Fo[i] for i in rest_index]
    Fz = np.transpose(np.matrix(Foz))
